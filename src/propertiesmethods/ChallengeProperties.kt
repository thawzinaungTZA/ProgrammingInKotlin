...
data class Course(var className: String) {
    ...
    val courseDes: String = "Course $className by $teacherName"
}
...
fun main(args: Array<String>) {
    ...
    //println("Not Lazy ${course.courseDes}")
//    course.setTeacherName("New Teacher")
//    println("New Course Desc ${course.courseDescription}")
